...
class Server:
    ...
    def johnny_update(self):
        ...
        for subName in self.subjectNames:
            ...
            vf , pd = vel_filter(self.pdata[subName], pos)
            vflp , vd = vel_filterlp(self.vfilter[subName], vf)

            # vf = np.asarray(calculate_raw_velocity(pos, self.prevpos, self.prevtime))
            # self.prevtime = time.time()
            # self.prevpos = pos
            ...
            #print('vf = ', vf, 'end') #
            #vf = calculate_raw_velocity(pos, self.prevpos, self.prevtime) #
            #print('vf2 = ', vf, 'end')  #
            ...
            # v2 = vf   # convert to m/s
            print('vf = ', np.linalg.norm(vf))
            #print("Vel=",v*1000)
